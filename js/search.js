...
const FETCH_URL_SEARCH = "https://script.google.com/macros/s/AKfycbzzUbOamX249pRIq0kRwxh_OScPvyF9FAhAJy8FAjpNG8DR7WZFMp_WksYV6Lp7GrLG/exec";
...
<li class="py-4">
    <div class="bg-white rounded-md border p-4">
        ...
        <div class="flex justify-end">
            <a href="${ datas[i].pdfUrl }" target="_blank" class="w-32 text-center bg-yellow-400 hover:bg-yellow-300 text-black p-2 rounded-md shadow-md">開く</a>
        </div>
    </div>
</li>
            `;
